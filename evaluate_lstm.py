"""
evaluate_lstm.py — Evaluation for Vanilla LSTM baseline.

Reports ADE/FDE in degrees per prediction horizon,
matching SMCHN Table 2 format for direct comparison.

Usage:
    python evaluate_lstm.py --tag LSTM_obs5_pred5 --split test
    python evaluate_lstm.py --tag LSTM_obs10_pred10 --split test
"""
...
def main():
    ...
    print(f'\n{"="*55}')
    print(f'  Vanilla LSTM | {args.tag} | {args.split}')
    print('='*55)
